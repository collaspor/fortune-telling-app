  ...
  return (
    <footer className="border-t border-border-subtle bg-bg-primary/50 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 py-8 text-center">
        ...
        <a
          href="https://github.com/collaspor/fortune-telling-app"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1.5 mt-3 text-xs text-text-secondary/40 hover:text-gold/60 transition-colors"
        >
